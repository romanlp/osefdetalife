...
test.describe('Onboarding Availability Step E2E (ATDD)', () => {
  ...
  test.skip('[P0] should display weekly schedule with open/closed toggles', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P0] should show time inputs when day is toggled open', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P1] should hide time inputs when day is toggled closed', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P1] should disable continue button when all days are closed', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P0] should add table group row', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P1] should add multiple table groups', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P1] should disable continue button when no table groups', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
  ...
  test.skip('[P0] should save data and navigate to step 3', async ({ page }) => {
    // THIS TEST WILL FAIL - UI not implemented yet
    await page.goto('/onboarding/availability');
